...
const summaryFields = new Set('id slug name city district type category image_url allowed_pets features quiz_tags suitability weight_limit extra_fee base_trust_score verified price address camera_support title summary short_answer author published_at updated_at starts_at ends_at status placement target_url sponsor last_verified'.split(' '));
